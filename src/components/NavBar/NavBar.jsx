        ...
        <div className="flex flex-col">
          ...
          {showNav && hideClose === 1 && (
            <div aria-label="Show Parallax website" className="flex flex-col">
              <Link
                to="/AboutProjOne"
                className="grid place-content-center w-16 h-10 rounded-lg text-black  text-xs bg-slate-400 hover:border-orange-600 hover:border-2 font-bold  hover:border-orange-600 hover:border-2 sm:w-32  sm:h-12 sm:text-lg m-1"
              >
                info
              </Link>
              <a
                ...
                className="grid place-content-center w-16 h-10 rounded-lg text-black text-center  text-xs bg-slate-400 hover:border-orange-600 hover:border-2 font-bold  hover:border-orange-600 hover:border-2 sm:w-32  sm:h-12 sm:text-lg m-1"
              >
                Github
              </a>
            </div>
